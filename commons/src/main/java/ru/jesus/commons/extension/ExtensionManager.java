package ru.jesus.commons.extension;
...
import ru.jesus.commons.extension.IExtension.ExtensionInfo;
...
public class ExtensionManager {
	...
	protected boolean loadExt(IExtension ext) {
		...
		if(info!=null && info.installRequired()) {
			if(!_plugins.containsKey(ext.getClass().getName()) || _plugins.get(ext.getClass().getName())<info.getVersion()) {
				try {
