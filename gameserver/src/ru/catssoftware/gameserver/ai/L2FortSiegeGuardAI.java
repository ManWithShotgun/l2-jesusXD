...
public class L2FortSiegeGuardAI extends L2CharacterAI implements Runnable
{
	...
	{
		if (target == null || target instanceof L2FortSiegeGuardInstance || target instanceof L2FortCommanderInstance || target instanceof L2FolkInstance || target instanceof L2DoorInstance || target instanceof L2PlayableInstance)
		{
